# Task 316 - Naver Read-Only Final Execution Approval Candidate Final Summary Outcome Certification Screen Flow

## 구현 목적

Task 315 후보 최종 요약 결과를 기반으로, 후보 최종 요약 결과를 read-only로 인증하는 패널을 추가합니다.

이 화면은 실제 승인, 실제 실행, 상품 변경 승인이 아닙니다.

## 상태 매핑 규칙

Task 315 `candidateFinalSummaryStatus`를 아래처럼 1:1로 매핑합니다.
...
Task 315의 `summaryFlowItems`를 그대로 재사용합니다.
...
Task 317은 사용자 별도 명시 승인 후에만 진행합니다.
