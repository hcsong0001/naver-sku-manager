...
## 8. 수동 UI POST 검증 연결
seed 성공 후 사용자는 다음의 URL을 열어 검증을 시작합니다.
`http://localhost:3000/dashboard/sku-keyword-draft-batches/<seeded-job-id>`

**검증 흐름:**
1. dev server를 localhost:55432 DATABASE_URL로 실행
2. seeded job detail page 접근
